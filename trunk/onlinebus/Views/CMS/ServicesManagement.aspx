...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    Service Management</asp:Content>
...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["del"] != null)
        {
            ...
            else
            {
                ...
                Response.Redirect("/CMS/ServicesManagement");
            }
        }
    }
    ...
    private void GetServices()
    {
        ...
        GridView1.DataSource = db.sp_SearchService(ViewData["Data"].ToString());
        GridView1.DataBind();
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 100%; float: left; margin-bottom: 5px; margin-top: 5px">
        <a href="/CMS/AddService">Add new Service</a>
    </div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Delete">
                    <ItemTemplate>
                        <a href="javascript:DeleteService('<%# Eval("Services_ID")%>','' )">
                ...
                <asp:TemplateField HeaderText="Edit">
                    <ItemTemplate>
                        <asp:HyperLink NavigateUrl='<%# "~/CMS/EditService/" + Eval("Services_ID") %>' ID="HyperLink1"
                            runat="server">
                ...
                <asp:TemplateField HeaderText="Title">
                    <ItemTemplate>
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("Services_Title") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Release">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Text='<%# Bind("Services_Release", "{0:d}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Date of Edit">
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("Services_Edit", "{0:d}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Number of View">
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("Services_ReadCount") %>'></asp:Label>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Active">
                    <ItemTemplate>
                        <asp:CheckBox ID="CheckBox1" runat="server" Checked='<%# Bind("Services_Active") %>'
                            Enabled='false' />
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:TemplateField>
    ...
    <script type="text/javascript">
        function DeleteService(menuid, title) {
            if (confirm("System going to delete this Services \n" + title + " \n Are you sure?")) {
